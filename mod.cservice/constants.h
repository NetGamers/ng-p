...
#define __CONSTANTS_H "$Id: constants.h,v 1.6 2002-09-24 20:06:18 jeekay Exp $"
 ...
 *
 * $Id: constants.h,v 1.6 2002-09-24 20:06:18 jeekay Exp $
 */
...
namespace sql
	...
	const string user_fields = "id,user_name,password,url,language_id,flags,last_updated_by,last_updated,email,coordx,coordy,coordz,alliance,comment,suspended_expire_ts,question_id,verificationdata,maxlogins";
