...
#define __CONSTANTS_H "$Id: constants.h,v 1.4 2002-02-16 21:40:01 jeekay Exp $"
 ...
 *
 * $Id: constants.h,v 1.4 2002-02-16 21:40:01 jeekay Exp $
 */
...
namespace sql
	...
	const string user_fields = "id,user_name,password,url,language_id,flags,last_updated_by,last_updated,email,coordx,coordy,coordz,alliance,comment,suspended_expire_ts";
