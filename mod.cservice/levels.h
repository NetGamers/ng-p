#ifndef __LEVELS_H
#define __LEVELS_H "$Id: levels.h,v 1.37 2002-10-20 02:12:10 jeekay Exp $"
 ...
 *
 * $Id: levels.h,v 1.37 2002-10-20 02:12:10 jeekay Exp $
 */
...
#if 0
  const int chancomment = 1;
  const int invme = 1;
  const int usercomment = 1;
