 ...
 * Caveats: None
 *
 * $Id: OPERJOINCommand.cc,v 1.4 2004-05-16 13:08:17 jeekay Exp $
 */
...
const char OPERJOINCommand_cc_rcsId[] = "$Id: OPERJOINCommand.cc,v 1.4 2004-05-16 13:08:17 jeekay Exp $" ;
