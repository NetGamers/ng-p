 ...
 * USA.
 *
 * $Id: ServerTimerHandlers.cc,v 1.2 2002-07-01 00:28:26 jeekay Exp $
 */
...
const char ServerTimerHandlers_cc_rcsId[] = "$Id: ServerTimerHandlers.cc,v 1.2 2002-07-01 00:28:26 jeekay Exp $" ;
